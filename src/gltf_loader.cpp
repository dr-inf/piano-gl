...
static std::optional<std::vector<std::byte>> getImageBytes(const fastgltf::Asset &asset, const fastgltf::Image &image,
...
static GLuint uploadImageTexture(const fastgltf::Asset &asset, std::size_t imageIndex, const fs::path &basePath,
...
static PrimitiveGPU uploadPrimitive(const fastgltf::Asset &asset, const fastgltf::Primitive &prim,
    ...
    for (std::size_t i = 0; i < positions.size(); ++i) {
        ...
        vertexData.insert(vertexData.end(),
                          {p.x, p.y, p.z, n.x, n.y, n.z, uv.x, uv.y, t.x, t.y, t.z, t.w, cutValues[i]});
    }
...
static void expandBounds(glm::vec3 &minOut, glm::vec3 &maxOut, const glm::mat4 &m, const glm::vec3 &localMin,
